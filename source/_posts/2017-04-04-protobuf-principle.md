...
![](http://i1.piimg.com/567571/c725b52942eaee49.png)
...
- WireType是指数据类型和Value的长度，下表列出全部类型：
  ![](http://i2.muimg.com/567571/0607f3608174c559.png)
- Value是指字段实际值
...
# 源码
至此把protobuf所有数据类型的原理进行了分析，上面的示例代码可到此下载：https://github.com/itvincent-git/protobuf-sample 。测试代码在`app/src/test/../ExampleUnitTest.java`。
